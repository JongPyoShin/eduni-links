...
let undoHistory=[],aiGeneration=0,aiTimer=null;
...
_UNDO_BUTTON_HTML = '<button class="btn" id="undo" type="button" disabled>무르기</button><button class="btn" id="hint" type="button">도움말</button>'
...
_PERSISTENCE_ENGINE_EXPORT_WITH_SAVE = (
    ...
    "createBoard,cloneBoard,boardKey,groupAt,tryMove,legalMoves,scoreBoard,aiPickMove,analyzeMove,analyzeAiDanger,"
...
def integrate_v2_coach(source: str, logic_script: str, ai_strategy_script: str = "", persistence_script: str = "") -> str:
    """Bind tested coach, optional 19x19 strategy, persistence, undo, and AI turn guards to Baduk v2.
    ...
    if runtime_ok and _POINTER_BLOCK in runtime_source and _RUNTIME_RESET_MARKER in runtime_source:
        ...
        if _UNDO_BUTTON_MARKER in runtime_source and _NEW_GAME_LISTENER in runtime_source:
