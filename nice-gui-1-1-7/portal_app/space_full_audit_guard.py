...
_AUDIT_GUARDED_MARKER = (
    ...
    "        }\n"
    "        if (!directionUi || directionUi.ok!==true || directionUi.checked!==50 || directionUi.total!==50 || directionUi.answerMode!=='destination-only') {\n"
    "          throw new Error('EDUNI direction destination-only UI audit did not pass 50/50; gameplay blocked');\n"
    "        }\n"
    "        return audit;\n"
    "      }\n\n"
    "      function makeQuestion(type) {\n"
