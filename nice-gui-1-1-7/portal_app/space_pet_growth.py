...
def _inject_pet_growth(html: str) -> str:
    ...
    html = _replace_once(html, "if (care>=15) return 3;", "if (care>=60) return 3;")
    html = _replace_once(html, "if (care>=8) return 2;", "if (care>=30) return 2;")
    html = _replace_once(html, "if (care>=3) return 1;", "if (care>=10) return 1;")
