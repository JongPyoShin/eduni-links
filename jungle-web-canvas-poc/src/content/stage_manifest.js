export const STAGES = {
  ...
  waterfall: {
    ...
    scenario: [
      ...
      { id: "waterDrops", kind: "clue", title: "물방울 반짝이", objective: "반짝이는 물방울 자국을 찾아보자" },
    ...
    visualPhases: {
      ...
      waterDrops: { palette: "wet-green", fog: 0.34, warmth: 0.3, density: 0.88, cue: "water-sparkle", ambience: "stream", landmark: "waterDrops", reveal: "waterfall-partial" },
